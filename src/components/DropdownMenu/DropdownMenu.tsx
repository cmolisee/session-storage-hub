...
const DropdownMenu = ({ className, label, options  }: IControlProps) => {
	...
	const containerClassNames = 'relative inline-block text-left cursor-pointer';
	const menuClassNames = 'dropdownMenuButton inline-flex w-full justify-center bg-transparent py-1 px-4 my-0.5 mx-2 font-bold hover:text-[var(--buttonHoverColor)]';
		...
		<div className={`${containerClassNames} ${className}`}>
			<div>
				<button 
					...
					<svg className={svgClassNames} viewBox={'0 0 20 20'} fill={'currentColor'} aria-hidden={'true'}>
